...
const initFilters = () => ({
    ...
    LastDeliveryDate: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
...
const ManagePurchaseMemo = () => {
    ...
    const exportToExcel = () => {
        const exportData = purchasememo.map((item) => ({
            ...
            "Delivery Date": item.LastDeliveryDate ?? '',
                        ...
                        <Col lg="12">
                            <Card>
                                <DataTable
                                    ...
                                    dataKey="Memo_ID"
                                    filters={filters}
                                    globalFilterFields={['PM_Number', 'PM_Date', 'LastDeliveryDate', 'CreatedDate', 'CreatedByName', 'ApproveStatus', 'RequestorName', 'Status']}
                                ...
                                >
                                    ...
                                    <Column
                                        ...
                                        sortable
                                        body={(rowData) => {
                                            const date = rowData?.LastDeliveryDate ? new Date(rowData.LastDeliveryDate) : null;
                                            return date ? date.toLocaleDateString("en-GB", {
                                                day: '2-digit',
                                                month: 'short',
                                                year: 'numeric'
