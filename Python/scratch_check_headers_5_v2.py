...
async def check_headers_5_v2():
    ...
    try:
        async with engine_live.connect() as conn:
            ...
            res = await conn.execute(text("SELECT * FROM tbl_salesinvoices_header WHERE salesinvoicenbr IN :invs"), {"invs": tuple(invoices)})
...
if __name__ == "__main__":
    asyncio.run(check_headers_5_v2())
