...
cursor.execute("DROP PROCEDURE IF EXISTS proc_AR_GetOutstandingInvoices")

sp_code = """
CREATE PROCEDURE `proc_AR_GetOutstandingInvoices`(
...
BEGIN
    ...
    IF p_receipt_id > 0 THEN
        SET v_receipt_id = p_receipt_id;
    END IF;
...
print("Updated SP proc_AR_GetOutstandingInvoices successfully.")
